<%-- 
    Document   : FurnitureUploadAction
    Created on : 24 Mar, 2024, 10:32:52 PM
    Author     : Admin
--%>
...
//checking if request cotains multipart data
    ...
    if (isMultipart) {
        ...
        String InsQry = "insert into tbl_furniture (furniture_image,furniture_price,furniture_description,place_id,furniture_address,furniture_contract_time,furniture_owner_id)"
                + "values('" + photo + "','" + value[0] + "','" + value[1] + "','" + value[3] + "','" + value[4] + "','" + value[5] +"','"+session.getAttribute("fid")+"')";
