<%-- 
    Document   : FurnitureRequest
    Created on : Apr 22, 2024, 10:33:00 AM
    Author     : mariy
--%>
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = 'ViewMoreFur.jsp?fid=<%=session.getAttribute("fid")%>';
...
<%
        ...
        String selQ="select * from tbl_furniture where furniture_id='"+ session.getAttribute("fid") +"'";    
        ...
        <form method="post">
            <table border="1" align="center">
                <tr>
                    ...
                    <td><textarea name="details"  readonly=""><%=rs.getString("furniture_description")%></textarea></td>
                </tr>
                 <tr>
                    <td>Furniture Price</td>
                    <td><input type="text" name="price" id="price" value="<%=rs.getString("furniture_price")%>" readonly=""></td>
                </tr>
                 <tr>
                    <td>From Date</td>
