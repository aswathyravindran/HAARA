    ...
    <body>
                ...
                <div class="form">
                    <form method="post">
                        <% if(request.getParameter("btnpay")!=null){
                            String s="update tbl_request set payment_status=1 where request_id='"+request.getParameter("id")+"'";
                            boolean sts=con.executeCommand(s);
                            if (sts) {
        %>
        <script>
        ...
        <%
                        ...
                        <div class="card space icon-relative">
                            ...
                            <input type="text" class="input" placeholder="Card Holder"  required="required"  onchange="nameval(this)" autocomplete="off"/>
