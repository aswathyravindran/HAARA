...
<%
    ...
    if (request.getParameter("rating_data") != null) {
        ...
        String ins = "INSERT INTO tbl_review(user_name,user_rating,user_review,review_datetime,property_id)"
    ...
    if (request.getParameter("action") != null) {
        ...
        String query = "SELECT * FROM tbl_review where property_id = '" + request.getParameter("id") + "' ORDER BY review_id DESC";
